                            ...
                            <form method="post" action="{{route('update-profile', Auth::user()->profile)}}" class="personal_validate" enctype="multipart/form-data">
                                ...
                                @method('PUT')
                                    <div class="form-row">
                                        ...
                                        <input type="text" name="full_name" class="form-control" value="{{Auth::user()->profile->full_name ?? ''}}" name="full_name">
                                        </div>
                                   
                                            <div class="form-group col-xl-6">
                                                <label class="mr-sm-2">Email</label>
                                                <input type="text" name="email" class="form-control" value="{{Auth::user()->profile->email ?? ''}}" name="email">
                                            </div>
                                        ...
                                        <div class="form-group col-12">
                                            <button type="submit" class="btn btn-warning pl-5 pr-5">Update</button>
                                        </div>
                                    </div>
                                </form>
