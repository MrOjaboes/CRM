      ...
      <div class="container-fluid">
        ...
        <div class="card card-default">
          ...
          @if(session()->has('message'))
                ...
                @endif
                    <br><br>
        <form action="{{route('update-note',$note->id)}}" method="POST" enctype="multipart/form-data">
            @csrf
             
            <div class="form-group">
                <label for="content">Note</label>
            <textarea name="content" id="" class="form-control" cols="30" value="{{$note->content}}" rows="10">{{$note->content}}</textarea>
            @error('content')
