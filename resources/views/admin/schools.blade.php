            ...
            <div class="col-md-10">
                <div class="card">
                    <div class="card-header border-0 pb-0">
                        <h4 class="card-title">Recent Added Schools <span class="badge badge-warning">{{$schools->count()}}</span></h4>
                              ...
                              <table class="table mb-0 table-responsive-sm">
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                      ...
                                      <a class="dropdown-item btn btn-info" title="School Details" href="{{route('school-details', $school->id)}}">Details</a>
                                    @endif
                                    @if(Auth::check() AND Auth::user()->user_type == 1 || Auth::user()->user_type == 3)
                                      <a class="dropdown-item" href="{{route('view-school-note', $school->id)}}">View Note</a>
                                      @endif
                                    </div>
                                  </div>
                             </td>
