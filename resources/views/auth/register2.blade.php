                 ...
                 <form class="form-horizontal" role="form" method="POST" action="{{ route('register') }}">
                            ...
                            <div class="inner-addon right-addon">
                                <div class="col-md-12 input-group-lg">
                                    ...
                                    <input type="text" class="form-control" style="border-radius: 4px; box-shadow:0px 2px 4px rgba(0,0,0,0.18); padding-right:40px; " name="username"  placeholder="Username">
                        ...
                        <div class="form-group{{ $errors->has('password_confirmation') ? ' has-error' : '' }}">
                            <div class="inner-addon right-addon">
                                <div class="col-md-12 input-group-lg">
                                <i class="fa fa-lock" aria-hidden="true"></i>
                                    <input type="password" class="form-control"  style="border-radius: 4px; box-shadow:0px 2px 4px rgba(0,0,0,0.18);" name="password_confirmation" placeholder="Confirm Password">                                  
                                </div>
                            </div>
                        </div>
