  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Add Close Deal Info</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{route('home')}}">Home</a></li>
              <li class="breadcrumb-item active">Close Deal</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
      ...
      <div class="container-fluid">
        ...
        <div class="card card-default">
          ...
          @if(session()->has('message'))
                ...
                @endif
                    <br><br>
        <form action="{{route('close-deal',$school->id)}}" method="POST" enctype="multipart/form-data">
            @csrf
             
            <div class="form-group">
                <label for="content">No. Of Users</label>
          ...
          <option value="{{$package->name}}">{{$package->name}} <b>{{$package->amount}}</b></option>
          @endforeach
          </select>
            @error('subject')
            <span class="invalid-feedback" role="alert">
            ...
            <div class="form-group col-12">
                <button type="submit" class="btn btn-danger pl-5 pr-5">Close Deal</button>
            </div>
        </form>
